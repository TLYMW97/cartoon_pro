<template>
    <div class="index-page">
            ...
            <div class="classify">
                ...
                <div class="all-classify"><span><a-icon type="appstore"/></span>全部分类</div>
            </div>
            <div class="recommend">
                <div class="re-l">
                    <my-swiper :imgs="imgs">
    ...
    <div class="index-p">
        <div class="renew">
            <cartoonCard class="renew-card" v-for="data in allManga" :key="data.mangaId" :mangaData="data"></cartoonCard>
        </div>
    </div>
    </div>
</template>
